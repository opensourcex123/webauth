...
import (
	...
	"github.com/opensourcex123/webauth/protocol/webauthncbor"
...
func verifyU2FFormat(att AttestationObject, clientDataHash []byte, platform string) (string, []interface{}, error) {
